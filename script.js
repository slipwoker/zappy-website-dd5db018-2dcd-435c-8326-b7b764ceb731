    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "אי די אס ייבוא ושיווק משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: 'dd5db018-2dcd-435c-8326-b7b764ceb731',
                    name: data.name || '',
                    email: data.email || '',
